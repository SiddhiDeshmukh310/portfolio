...
const Projects = () => {
  const projects: Project[] = [
    {
      title: "Automated Book Publication",
      description: "An AI-powered workflow automation system that scrapes content from online sources, rewrites it using AI models, and processes human feedback for quality improvement. Includes multi-agent execution and RAG integration.",
      tags: ["Python", "LangChain", "FastAPI", "ChromaDB"],
      link: "https://github.com/SiddhiDeshmukh310"
    },
    {
      title: "ECG Monitoring System",
      description: "A real-time ECG monitoring and visualisation platform that processes raw ECG signals, detects anomalies, and displays results through interactive charts for early cardiac detection.",
      tags: ["Python", "NumPy", "Pandas", "Scikit-Learn"],
      link: "https://github.com/SiddhiDeshmukh310"
    },
    {
      title: "Gym Management AI",
      description: "A platform capable of detecting incorrect exercise hand postures using computer vision and pose-estimation techniques, helping users maintain proper form.",
      tags: ["Computer Vision", "Pose-estimation", "JS", "MySQL"],
      link: "https://github.com/SiddhiDeshmukh310"
    },
    {
      title: "Student Grading System",
      description: "A web-based application that allows teachers to manage student records and automatically calculate grades, storing data in a structured database.",
      tags: ["MySQL", "PHP", "JS", "HTML5"],
      link: "https://github.com/SiddhiDeshmukh310"
    }
  ];
...
const AIChat = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'ai', content: "Hi! I'm Siddhi's AI double. Ask me about her education at IIIT Pune, her AI-ML projects, or her SIH hackathon experiences!" }
  ]);
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          Background: Computer Engineering student at IIIT Pune (2022-2026).
          Education: GPA 8.91 at IIIT Pune.
          Experience: AI/ML Virtual Intern (01/2025 - 03/2025).
          Projects: Automated Book Publication (LangChain), ECG Monitoring (Real-time ML), SIH Gym AI.
          Top Achievements: SIH 2024 Level 2, SIH 2025 Participant, MIT-WPU Hackathon, L'Oréal Brandstorm.
          Technical Stack: Python, React, Next.js, FastAPI, GenAI, RAG.
          Tone: Ambitious, technical, and highly professional. 
          Answer questions about Siddhi's background and technical skills. Keep it brief.`,
        }
      });

      const aiText = response.text || "I'm having trouble connecting to my neural network. Try asking about IIIT Pune!";
